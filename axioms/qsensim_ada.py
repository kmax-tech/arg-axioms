...
class QSenSim_mean_ada(Axiom) :
    name = "QSenSim_mean_approequal_ada"
...
class QSenSim_mean_exact_ada(Axiom) :
    name = "QSenSim_mean_exact_ada"
...
class QSenSim_max_ada(Axiom) :
    name = "QSenSim_max_approequal_ada"
...
class QSenSim_max_exact_ada(Axiom) :
    name = "QSenSim_max_exact_ada"
